...
const freeze = readJson('docs/launch-work/canada/selection-freeze.json')
...
const output = {
  ...
  invocation: 'node --experimental-strip-types docs/launch-work/canada/evaluate-canada.mjs',
  contract: {
    provider: 'Polymarket',
    marketId: '517586',
  ...
  freeze: {
    path: 'docs/launch-work/canada/selection-freeze.json',
    sha256: sourceHash('docs/launch-work/canada/selection-freeze.json'),
  ...
  dataset: {
    ...
    outputCsvPath: 'docs/launch-work/canada/canada-hourly.csv',
    outputCsvSha256: sourceHash('docs/launch-work/canada/canada-hourly.csv'),
    audit,
...
writeFileSync('docs/launch-work/canada/measurements.json', `${JSON.stringify(output, null, 2)}\n`)
