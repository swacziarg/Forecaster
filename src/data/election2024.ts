...
export const electionEvents: ImpactEventDefinition[] = [
  ...
  },
  {
    ...
    expectedDirection: 'Ambiguous',
    interpretation: 'The stabilized market estimate was essentially unchanged. Traders did not immediately reward the interview\'s reach or punish its controversial content, suggesting those forces were offsetting or already priced in.',
    competingExplanation: 'Rogan\'s audience may already have leaned toward Trump, and any persuasion or turnout effect would not necessarily appear inside a 36-hour market window.',
