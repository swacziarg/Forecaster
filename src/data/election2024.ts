...
export const electionEvents: ImpactEventDefinition[] = [
  ...
  },
  {
    ...
    summary: 'Trump spent nearly three hours on The Joe Rogan Experience, reaching a very large audience that skewed toward younger men.',
    mechanism: 'Long-form, nontraditional media could humanize Trump and mobilize a demographic his campaign was actively targeting.',
    expectedDirection: 'Helps Trump',
    interpretation: 'Despite enormous reach and later strategic importance, the stabilized market estimate was essentially unchanged. Reach did not create an immediate measurable repricing.',
    competingExplanation: 'The audience may already have leaned toward Trump, and persuasion or turnout effects would not necessarily appear within 36 hours.',
    confidence: 'Medium', attributionShare: 30,
    source: { label: 'The Joe Rogan Experience #2219', publisher: 'PowerfulJRE', url: 'https://www.youtube.com/watch?v=hBMoPUAeLnY', publishedAt: '2024-10-25T00:00:00Z' },
  },
  {
